...
apollo_control = list(
  modelName ="mnl_4_int",
  modelDescr ="mnl_4_cup_option_int",
  indivID   ="record", 
  nCores    = 3,
  seed      = 123456,
...
# including interactions with discount creates NA SE
# hGroup_DIS_REF = 0
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  V = list()
  V[['DIS']]        =  b_DIS + b_CHA_DIS * CHA_DIS + b_hGroup_CHA_DIS * hGroup
  V[['RET']]        =  b_RET + b_DIS_RET * DIS_RET + b_DSC_RET * DSC_RET + b_DAM_RET * DAM_RET + b_hGroup_DIS_RET * hGroup
  V[['REF']]        =  b_REF + b_DIS_REF * DIS_REF + b_hGroup_DIS_REF * hGroup 
  V[['OUT']]        =  b_OUT 
