...
### Set core controls
apollo_control = list(
  modelName ="lc-4choice-2classes-treatment-Q1x7-Q3x7-Q3x3-Q3x9_10-socio",
  modelDescr ="Latent class four choices two classes treatment plus Q1x7 Q3x3 Q3x9_10 socio",
  indivID   ="record", 
  nCores    = 3,
  seed      = 123456,
...
apollo_lcPars=function(apollo_beta, apollo_inputs){
  ...
  lcpars[["m_REF"]] = list(m1_REF, m2_REF)
  ...
  lcpars[["m_DIS_REF"]] = list(m1_DIS_REF, m2_DIS_REF)
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  while(s<=2){
    ...
    V[['REF']]        =  m_REF[[s]] + m_DIS_REF[[s]] * DIS_REF
    V[['OUT']]        =  m_OUT[[s]]    
