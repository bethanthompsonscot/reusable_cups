...
# data from treatment 1 and 2
treatment_1_df <- read_rds("data/mnl_output/mnl_4_untreated_model.rds")
treatment_1_covar_df <- read_csv("data/mnl_output/mnl_4_untreated_covar.csv") %>% 
  dplyr::select(-`...1`) 
treatment_2_df <- read_rds("data/mnl_output/mnl_4_treated_model.rds")
treatment_2_covar_df <- read_csv("data/mnl_output/mnl_4_treated_covar.csv") %>% 
  dplyr::select(-`...1`) 
...
coefficients_1 <- treatment_1_df$estimate[2:9]
coefficients_2 <- treatment_2_df$estimate[2:9]
...
print(results)
results %>% write_csv("data/output/treatment_comparison_1_2.csv")
